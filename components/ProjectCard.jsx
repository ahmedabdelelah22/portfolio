...
<div className='relative w-full h-[300px] flex items-center justify-center 
                bg-[url("/work/project-bg-light.png")] bg-cover bg-center 
                dark:bg-[url("/work/project-bg-dark.png")] overflow-visible '>
...
//             className="relative w-auto h-atuo rounded-xl p-px bg-gray-900 backdrop-blur-md text-gray-800 overflow-hidden shadow-lg cursor-pointer"
...
//             <div className="relative z-10 bg-gray-900/75  h-full w-full rounded-[11px] flex flex-col items-center justify-center text-center">

//                 <Image src={project.image} alt="Profile Avatar" width={400} height={400} className="object-cover rounded-xl shadow-md my-4 px-2" />

//                 <h2 className="text-2xl font-bold text-white mb-1">{project.name}</h2>

//                 <p className="text-sm text-indigo-500 font-medium mb-4">{project.category}</p>
